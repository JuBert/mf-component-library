...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href),import:true},'tailwindcss':{get:()=>()=>__federation_import(new URL('__federation_shared_tailwindcss-Bwvv78dv.js', import.meta.url).href),import:true},'jotai':{get:()=>()=>__federation_import(new URL('__federation_shared_jotai-0ShK06sG.js', import.meta.url).href),import:true}};
